...
org $C0CDA0
base $80CDA0
; Luckily this chunk of free space is in the same relative location in the
; crossover, so no JSRs need to change to JSLs! Copypasta person's code, but
; removed all of the definitions he created in case of conflicts with
; additional files being used
Missile_Counter:
...
MissileMax:
    ...
    ; Draw SM_Numbers
    LDX $12 : LDA SM_Numbers,x : ORA $18 : STA $7EC61C
    LDX $14 : LDA SM_Numbers,x : ORA $18 : STA $7EC61E
    LDX $16 : LDA SM_Numbers,x : ORA $18 : STA $7EC620
    ; Load new missile icon, pieced together from graphics starting at D3200, and store them to the HUD
    LDA #$0049 : ORA $18 : STA $7EC65C
